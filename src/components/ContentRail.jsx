          ...
          return (
            <div 
              ...
              className={`
                ...
                ${isActive ? 'w-56 md:w-64 z-10' : 'w-40 md:w-44 opacity-60 hover:opacity-90 hover:scale-105'}
              `}
            >
              {/* Card Container */}
              <div className={`
                relative rounded-xl overflow-hidden aspect-[16/9] shadow-2xl transition-all duration-500 mb-8
                ${isActive
